// src/ui/components/shared/ToggleSwitch.tsx
...
interface ToggleSwitchProps {
  ...
  /** Optional ID for the dot element (for external references) */
  dotId?: string;
  /** Color when toggle is ON (defaults to COLORS.accent.info) */
  activeColor?: string;
  /** Color when toggle is OFF (defaults to COLORS.text.primary) */
  inactiveColor?: string;
  /** Track background when ON (defaults to COLORS.bg.darker) */
  trackActiveColor?: string;
  /** Track background when OFF (defaults to COLORS.border.default) */
